...
'''eee = 35
pros, de = naiti_prostie_i_deliteli_menshe(100000, 0)
ad = set(pros)
a = nayti_prostie_deliteli(eee, pros, ad, de)
ded = vse_deliteli(a)
print ded
#3798207594720'''
pros, de = naiti_prostie_i_deliteli_menshe(640000, 50000)
ad = set(pros)
izd = []
...
ch = range(1,28124)
chi = set(ch)    
for i in xrange(len(izd)):
    if i % 200 == 0:
        print i
    for j in xrange(len(izd)):
        vvv = izd[i]+izd[j]
        if vvv <= 28123:
            vi.append(vvv)     
nov = []
